...
dist_AB, _ = calculate_causal_distance_between_images(img_A, img_B, scaling_parameter_c=C)
print(dist_AB)
print("#################################################################")


print("################### Causal Distance Between AD #########################")
dist_AD, _ = calculate_causal_distance_between_images(img_A, img_D, scaling_parameter_c=C)
print(dist_AD)
print("#################################################################")