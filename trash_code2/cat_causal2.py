...
from distance_causal_version3 import *
from utils import *
...
# dist_AA, _ = calculate_causal_distance_between_images(img_A, img_A, scaling_parameter_c)
# print(dist_AA)
# print("#################################################################")


print("################### Causal Distance Between AB #########################")
dist_AB, _ = calculate_causal_distance_between_images_version3(img_A, img_B, scaling_parameter_c)
print(dist_AB)
print("#################################################################")


print("################### Causal Distance Between AD #########################")
dist_AD, _ = calculate_causal_distance_between_images_version3(img_A, img_D, scaling_parameter_c)
print(dist_AD)
print("#################################################################")